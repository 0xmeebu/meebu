...
{proposalsList.map((proposal, index) => (
      <Grid.Col span={4}><IssueCard orgAddress={proposal.orgAddress} title={proposal.title} tallyingSystem={proposal.tallyingSystem} description={proposal.description}></IssueCard></Grid.Col>
           ))}
    </Grid>
  );
}
